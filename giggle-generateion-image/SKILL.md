---
name: giggle-image
description: Generate AI images with Seedream model via giggle.pro. Supports text-to-image, image-to-image, and multi-image fusion (up to 10). Use when user needs to create or generate images. Use cases: (1) generate from text description, (2) generate with reference images, (3) multi-image fusion, (4) custom aspect ratio and count. Trigger keywords: generate image, draw, create picture, AI art, seedream, seedream45.
user-invocable: true
...
Generate AI images with Seedream model (seedream45) via giggle.pro platform.
...
```
giggle-image task_id: xxx (submitted: YYYY-MM-DD HH:mm)
```
...
```json
{
  "action": "add",
  "job": {
    "name": "giggle-image-<first 8 chars of task_id>",
    "schedule": {
      "kind": "every",
      "everyMs": 45000
    },
