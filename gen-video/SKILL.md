...
使用 giggle.pro 提供的 grok-imagine 模型生成视频。支持文生视频 (text-to-video) 和图生视频 (image-to-video) 两种模式。
...
API Key 获取地址：https://giggle.pro/api-key
...
| 错误码 | 说明 | 建议 |
|--------|------|------|
| 401 | 认证失败 | 检查 GIGGLE_API_KEY 是否正确 |
| 402 | 余额不足 | 前往 giggle.pro 充值 |
