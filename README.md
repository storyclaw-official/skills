...
| [giggle-generation-image](#giggle-generation-image) | AI 图像生成（Seedream 模型） | Giggle.pro | GIGGLE_API_KEY |
...
```bash
# 文生图
python3 giggle-generation-image/scripts/seedream_api.py \
  --prompt "赛博朋克城市夜景" \
  --aspect-ratio 16:9
...
├── giggle-generation-image/      # AI 图像生成（Seedream）
...
| 平台 | 网址 | 使用技能 |
|------|------|---------|
| Giggle.pro | giggle.pro | giggle-drama、giggle-aimv、giggle-music、giggle-generation-image |
