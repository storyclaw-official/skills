...
| [gen-music](./gen-music/) | AI 音乐生成 | giggle.pro / Suno V5 |
| [gen-image](./gen-image/) | AI 图像生成 | giggle.pro / Nano Banana Pro |
| [gen-video](./gen-video/) | Grok-Imagine 视频生成 | giggle.pro / grok-imagine |
...
命令行参数 `--api-key` > 环境变量 > `.env` 文件（三级搜索：当前目录 > 技能目录 > 项目根目录）
